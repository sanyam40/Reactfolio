  ...
  return (  
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10">
      ...
      <div className="bg-white flex flex-row justify-center gap-12 py-3 rounded-sm text-[25px] text-[#344151]">
        <button onClick={increment} className="border-r-2 text-center w-20 border-[#bfbfbf] text-5xl">+</button>
        <div className="font-bold gap-12 text-5xl">{count}</div>
        <button onClick={decrement} className="border-l-2 text-center w-20 border-[#bfbfbf] text-5xl">-</button>
      </div>
